...
setup(
    ...
    entry_points={
        "console_scripts": [
            "block_cls = dofbot_garbage_yolov5.main:main",
            "component_sort = dofbot_garbage_yolov5.component_sort:main",
            "component_offset_tuner = dofbot_garbage_yolov5.component_offset_tuner:main",
            "single_object_grasp_test = dofbot_garbage_yolov5.single_object_grasp_test:main",
            "component_grip_tuner = dofbot_garbage_yolov5.component_grip_tuner:main",
        ],
    },
)
